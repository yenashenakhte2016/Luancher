...
----config----
local bot_api_key = "225606878:AAElL_HXQyE8S02uCia-SsK1BZB7_c54uZ8"
...
local oo = io.popen('cd $HOME ; cd DBTeam ; killall screen ; killall tmux ; killall telegram-cli ; screen ./launch.sh')
		end
	end
